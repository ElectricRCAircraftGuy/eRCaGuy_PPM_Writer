...
// #define TC_USE_TIMER0 //8-bit, normally controls micros(), millis(), etc <--use if you don't want
// any conflict with the servo library, and you are going to use eRCaGuy_TimerCounter in place of
// micros() and millis()
...
//-Don't forget that a direct-port-access write like this takes 2 clock cycles, or 0.125 us, so you
